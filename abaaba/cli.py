...
if __name__ == '__main__':
    ...
    parser.add_argument("--ak",required=(not "AK_ABA" in os.environ.keys()),help="ALI's API KEY")
    parser.add_argument("--sk",required=(not "SK_ABA" in os.environ.keys()),help="ALI's API SECRET")
    parser.add_argument("-s","--source",help="source directory",required=False)
