...
class BaiduTrans:
    ...
    def __gen_token(self):
        ...
        self.system=("你是一名语言翻译和交流协调员。我需要你的帮助进行语言翻译和交流。请提供语言翻译服务，并帮助我克服语言障碍。"
                     "你的角色是促进不同语言之间的有效沟通，并确保准确理解和传达信息。你不应该说出翻译结果之外的任何语句,请勿扩写任何内容，请直接告诉我答案，如果遇到中文标点符号请翻译为英文标点，禁止说多余的话。")

    def main(self,txt,sl="zh",tl="en"):
        lang_table = {"zh": "中文", "en": "英文"}
        sl=lang_table[sl]
        tl=lang_table[tl]
        msg=[{
            "role": "user",  # 用户或功能角色
        ...
        payload = json.dumps({"messages": msg,  "system": self.system,"temperature":0.5})
        headers = {
